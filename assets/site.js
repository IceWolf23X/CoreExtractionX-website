...
const themeKey = "coreextractionx-theme";
...
const resourceLinks = [
  {
    ...
    copy: "Replacement rules, extra drops, permissions, and scope.",
    href: "./features.html",
  },
  {
    label: "Setup",
    title: "Installation Guide",
    copy: "Paper requirements, generated files, and first tests.",
    href: "./installation.html",
  },
  {
    label: "Config",
    title: "Configuration Reference",
    copy: "config.yml, ores.yml, messages.yml, reload rules, and troubleshooting.",
    href: "./configuration.html",
  },
  {
    label: "FAQ",
    title: "Complete FAQ",
    copy: "Common server-owner questions about mining behavior.",
    href: "./faq.html",
  },
  {
    label: "Ops",
    title: "Troubleshooting",
    copy: "Config validation, permissions, Silk Touch, drops, and reload checks.",
    href: "./configuration.html#troubleshooting-quick-reference",
  },
  {
    label: "Release",
    title: "Production Validation",
    copy: "Checklist before enabling extraction rules for players.",
